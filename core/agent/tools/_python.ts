...
//      real location — it is core/agent/tools/_python.ts, so three ".." hops
//      land at the repo root regardless of which run dir launched opencode
//      (a symlinked tools dir resolves to its real path).
...
// _python.ts sits at core/agent/tools/, so three levels up = repo root.
