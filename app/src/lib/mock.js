...
// templates the agent proposes in the InputSpec / OutputSpec pickers.
...
export async function mockCreateDataset(body) {
  ...
  const ds = {
    schema_version: "1",
    id,
    name: (body?.name || "New dataset").trim(),
    description: body?.description || "",
    databases: Array.isArray(body?.databases) ? [...body.databases] : [],
    cohort: {
