...
import {
  ...
  predicateInputText,
  applyPredicateInput,
} from "./auditDetailChips.js";

// Shapes copied from the real seed artifacts (seed/audits/cord-ph/spec.json,
// seed/audits/cord-ph/mapping.json, seed/databases/cord-ph/model.json),
