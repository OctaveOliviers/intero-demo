...
DATABASES = {
    "cord-ph": {
        "csv_dir": Path("data/database/cord-ph/csv"),
        "db_path": Path("data/database/cord-ph/sql/cord_ph.sqlite"),
    },
    "acute-sore-throat": {
        "csv_dir": Path("data/database/acute-sore-throat-audit/csv"),
        "db_path": Path("data/database/acute-sore-throat-audit/sql/acute_sore_throat.sqlite"),
    },
    "synthea": {
        "csv_dir": Path("data/database/synthea-data/csv"),
        "db_path": Path("data/database/synthea-data/sql/synthea.sqlite"),
    },
    "npda-clinical": {
        "csv_dir": Path("data/database/npda-clinical/csv"),
        "db_path": Path("data/database/npda-clinical/sql/npda_clinical.sqlite"),
    },
    "npda-demographics": {
        "csv_dir": Path("data/database/npda-demographics/csv"),
        "db_path": Path("data/database/npda-demographics/sql/npda_demographics.sqlite"),
    },
}

DEFAULT_CSV_DIR = Path("data/database/cord-ph/csv")
DEFAULT_DB_PATH = Path("data/database/cord-ph/sql/cord_ph.sqlite")
