...
python3 -m data.database.scripts.build_emr_db --csv-dir data/database/cord-ph/csv --db data/database/cord-ph/sql/cord_ph.sqlite
```
...
```bash
sqlite3 data/database/cord-ph/sql/cord_ph.sqlite
.tables
```
